...
WHITELIST_PORTS = {
    1188, 1189, 1190,  # deeplx RESI backends -- DO NOT BLOCK
    3001, 3002,         # ST-Proxy (3002) + misc
    3010,               # new-api
    8080, 8000,         # common web ports used by internal services
    8089, 8090,         # unitool-proxy / ticnote-proxy
