  ...
  "apps": [
    {
      ...
      "env": {
        ...
        "REPLIT_SUBNODES": "https://c424491c-db06-452b-90ff-a772aa24c1fe-00-38dq9bvr44ayf.spock.replit.dev/api/gateway,https://gh-cli-install--bandersonndz.replit.app/api/gateway"
      },
      "restart_delay": 3000,
      "max_restarts": 20,
      "watch": false,
