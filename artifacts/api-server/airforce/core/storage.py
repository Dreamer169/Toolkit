...
class AccountStorage:
    ...
    def save_account(self, username: str, password: str, api_key: str) -> bool:
        ...
        try:
            ...
            self._sync_unified_db(username, password, api_key)
            return True
        except Exception:
            return False

    def _sync_unified_db(self, username: str, password: str, api_key: str) -> None:
        """同步写入统一数据库 /data/Toolkit/artifacts/api-server/data.db"""
