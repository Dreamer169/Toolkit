...
def fingerprint_script(profile: BrowserProfile) -> str:
    ...
    // ── chrome.* stubs (comprehensive, direct assign) ─────────────────
    try {{
        ...
        _c.loadTimes = function(){{ return {{requestTime:_t0,startLoadTime:_t0,commitLoadTime:_t0+0.05,
            finishDocumentLoadTime:_t0+0.4,finishLoadTime:_t0+0.5,firstPaintTime:_t0+0.15,firstPaintAfterLoadTime:0,
